...
struct AppStoreHeroHome: View {
    // MARK: Animation Properties
    @State var currentItem: Today?
    @State var showDetailPage: Bool = false

    // Marched Geometry Effect
            ...
            VStack(spacing: 30) {
                ...
                ForEach(todayItems){ item in
                    Button {
                        ...
                        CardView(item: item)
                        // For matched geometry effect we didnt applied padding instead applying scaling
...
//                VStack(spacing: 15) {
//                    // Dummy text
//                    Text("sdf lksjdfl kjdslfj dslkfj lksdjflksdjf klsdjfkljsd flkjsdlfkjsdlk fjdslkj flkdsjflksdjklfjdslk fjsdlkkdjflksjflksdj kjsk jdslkf jsdlkj flksdjf lksdj flkjsdlkf jdslkj fdskj flkjsdl kfjsdlkj flksdjf lksdf lksjdfl kjdslfj dslkfj lksdjflksdjf klsdjfkljsd flkjsdlfkjsdlk fjdslkj flkdsjflksdjklfjdslk fjsdlkkdjflksjflksdj kjsk jdslkf jsdlkj flksdjf lksdj flkjsdlkf jdslkj fdskj flkjsdl kfjsdlkj flksdjf lksdf lksjdfl kjdslfj dslkfj lksdjflksdjf klsdjfkljsd flkjsdlfkjsdlk fjdslkj flkdsjflksdjklfjdslk fjsdlkkdjflksjflksdj kjsk jdslkf jsdlkj flksdjf lksdj flkjsdlkf jdslkj fdskj flkjsdl kfjsdlkj flksdjf lksdf lksjdfl kjdslfj dslkfj lksdjflksdjf klsdjfkljsd flkjsdlfkjsdlk fjdslkj flkdsjflksdjklfjdslk fjsdlkkdjflksjflksdj kjsk jdslkf jsdlkj flksdjf lksdj flkjsdlkf jdslkj fdskj flkjsdl kfjsdlkj flksdjf lk")
//                        .multilineTextAlignment(.leading)
//                        .lineSpacing(10)
//                        .padding(.bottom, 20)
//
